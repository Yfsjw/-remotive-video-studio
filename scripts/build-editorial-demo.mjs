...
const assets=[
  ...
  {
    id:"galapagos",
    title:"NASA SVS — Galapagos Computer Graphics",
    url:"https://svs.gsfc.nasa.gov/vis/a000000/a000000/a000065/a000065.mp4",
    page:"https://svs.gsfc.nasa.gov/65/",
    license:"NASA public-domain media; attribution to NASA's Scientific Visualization Studio",
    file:"nasa-galapagos.mp4"
  }
];
...
const beats=[
 ...
 {id:"density",asset:"galapagos",trim:4,caption:"That meant more computing could fit into the same limited space.",type:"concept"},
